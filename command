...
python tools/train.py ./configs/beit/beit-Uavflood.py --work-dir work_dirs/UAVflood/beit
...
python tools/train.py ./configs/swin/Swin-uavflood-256x256.py --work-dir work_dirs/GFflood/Swin
