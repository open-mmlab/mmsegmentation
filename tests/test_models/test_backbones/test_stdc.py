...
def test_feature_fusion_module():
    ...
    assert x_ffm.conv1.in_channels == 32
    assert x_ffm.conv2.in_channels == 8
    assert x_ffm.conv2.out_channels == 32
...
def test_attention_refinement_module():
    ...
    assert x_arm.conv.in_channels == 128
    assert x_arm.conv_attn.out_channels == 32
