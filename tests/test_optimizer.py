...
from mmseg.core import OPTIMIZER_BUILDERS, DefaultOptimizerConstructor
from mmseg.core.optimizer import build_optimizer, build_optimizer_constructor
from mmseg.core.optimizer.builder import TORCH_OPTIMIZERS
...
def test_build_optimizer_constructor():
    ...
    from mmseg.core import OPTIMIZERS
