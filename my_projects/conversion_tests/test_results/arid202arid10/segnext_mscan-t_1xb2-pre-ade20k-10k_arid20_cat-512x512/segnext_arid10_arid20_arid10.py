...
launcher = 'none'
load_from = 'my_projects/conversion_tests/selection_trained/arid20_cat/segnext_mscan-t_1xb2-pre-ade20k-10k_arid20_cat-512x512/weights.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    output_dir=
    'my_projects/conversion_tests/test_results/arid202arid10/segnext_mscan-t_1xb2-pre-ade20k-10k_arid20_cat-512x512/pred_results',
...
visualizer = dict(
    ...
    output_dataset='ARID20',
    save_dir=
    'my_projects/conversion_tests/test_results/arid202arid10/segnext_mscan-t_1xb2-pre-ade20k-10k_arid20_cat-512x512/show',
    target_dataset='ARID10',
    test_dataset='ARID10',
...
work_dir = 'my_projects/conversion_tests/test_results/arid202arid10/segnext_mscan-t_1xb2-pre-ade20k-10k_arid20_cat-512x512'
