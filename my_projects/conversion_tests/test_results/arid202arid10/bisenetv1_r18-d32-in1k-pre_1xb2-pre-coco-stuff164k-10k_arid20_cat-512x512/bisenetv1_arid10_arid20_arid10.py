...
launcher = 'none'
load_from = 'my_projects/conversion_tests/selection_trained/arid20_cat/bisenetv1_r18-d32-in1k-pre_1xb2-pre-coco-stuff164k-10k_arid20_cat-512x512/weights.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    keep_results=True,
    output_dataset='ARID20',
    output_dir=
    'my_projects/conversion_tests/test_results/arid202arid10/bisenetv1_r18-d32-in1k-pre_1xb2-pre-coco-stuff164k-10k_arid20_cat-512x512/pred_results',
    target_dataset='ARID10',
    test_dataset='ARID10',
...
visualizer = dict(
    ...
    output_dataset='ARID20',
    save_dir=
    'my_projects/conversion_tests/test_results/arid202arid10/bisenetv1_r18-d32-in1k-pre_1xb2-pre-coco-stuff164k-10k_arid20_cat-512x512/show',
    target_dataset='ARID10',
    test_dataset='ARID10',
...
work_dir = 'my_projects/conversion_tests/test_results/arid202arid10/bisenetv1_r18-d32-in1k-pre_1xb2-pre-coco-stuff164k-10k_arid20_cat-512x512'
