...
launcher = 'none'
load_from = 'my_projects/conversion_tests/selection_trained/hots_v1/maskformer_swin-t_upernet_1xb2-pre-ade20k-10k_hots-v1-512x512/weights.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    output_dataset='HOTS',
    output_dir=
    'my_projects/conversion_tests/test_results/hots2hots_cat/maskformer_swin-t_upernet_1xb2-pre-ade20k-10k_hots-v1-512x512/pred_results',
...
visualizer = dict(
    ...
    output_dataset='HOTS',
    save_dir=
    'my_projects/conversion_tests/test_results/hots2hots_cat/maskformer_swin-t_upernet_1xb2-pre-ade20k-10k_hots-v1-512x512/show',
    target_dataset='HOTS_CAT',
    test_dataset='HOTS_CAT',
...
work_dir = 'my_projects/conversion_tests/test_results/hots2hots_cat/maskformer_swin-t_upernet_1xb2-pre-ade20k-10k_hots-v1-512x512'
