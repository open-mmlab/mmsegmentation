...
launcher = 'none'
load_from = 'my_projects/conversion_tests/selection_trained/hots_v1_cat/segformer_mit-b0_1xb2-10k_hots-v1-cat-512x512/weights.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    output_dir=
    'my_projects/conversion_tests/test_results/hots_cat2irl_vision_cat/segformer_mit-b0_1xb2-10k_hots-v1-cat-512x512/pred_results',
...
visualizer = dict(
    ...
    output_dataset='HOTS_CAT',
    save_dir=
    'my_projects/conversion_tests/test_results/hots_cat2irl_vision_cat/segformer_mit-b0_1xb2-10k_hots-v1-cat-512x512/show',
    target_dataset='IRL_VISION_CAT',
    test_dataset='IRL_VISION_CAT',
...
work_dir = 'my_projects/conversion_tests/test_results/hots_cat2irl_vision_cat/segformer_mit-b0_1xb2-10k_hots-v1-cat-512x512'
