...
test_evaluator = dict(
    ...
    output_dir=
    'my_projects/conversion_tests/test_results/irl_vision2irl_vision_cat/mask2former_r50_1xb2-pre-ade20k-10k_irl_vision_sim-512x512/pred_results',
...
visualizer = dict(
    ...
    output_dataset='IRL_VISION',
    save_dir=
    'my_projects/conversion_tests/test_results/irl_vision2irl_vision_cat/mask2former_r50_1xb2-pre-ade20k-10k_irl_vision_sim-512x512/show',
    target_dataset='IRL_VISION_CAT',
    test_dataset='IRL_VISION_CAT',
...
work_dir = 'my_projects/conversion_tests/test_results/irl_vision2irl_vision_cat/mask2former_r50_1xb2-pre-ade20k-10k_irl_vision_sim-512x512'
