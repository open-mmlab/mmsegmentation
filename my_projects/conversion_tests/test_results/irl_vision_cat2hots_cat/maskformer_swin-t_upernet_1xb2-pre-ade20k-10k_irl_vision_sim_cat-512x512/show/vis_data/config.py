...
launcher = 'none'
load_from = 'my_projects/conversion_tests/selection_trained/irl_vision_cat/maskformer_swin-t_upernet_1xb2-pre-ade20k-10k_irl_vision_sim_cat-512x512/weights.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    output_dir=
    'my_projects/conversion_tests/test_results/irl_vision_cat2hots_cat/maskformer_swin-t_upernet_1xb2-pre-ade20k-10k_irl_vision_sim_cat-512x512/pred_results',
...
visualizer = dict(
    ...
    output_dataset='IRL_VISION_CAT',
    save_dir=
    'my_projects/conversion_tests/test_results/irl_vision_cat2hots_cat/maskformer_swin-t_upernet_1xb2-pre-ade20k-10k_irl_vision_sim_cat-512x512/show',
    target_dataset='HOTS_CAT',
    test_dataset='HOTS_CAT',
...
work_dir = 'my_projects/conversion_tests/test_results/irl_vision_cat2hots_cat/maskformer_swin-t_upernet_1xb2-pre-ade20k-10k_irl_vision_sim_cat-512x512'
