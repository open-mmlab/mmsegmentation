...
launcher = 'none'
load_from = 'my_projects/zero_shot/models/maskformer_swin-t_upernet_8xb2-160k_ade20k-512x512/weights.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    output_dir=
    'my_projects/zero_shot/results/hots_v1/maskformer_swin-t_upernet_8xb2-160k_ade20k-512x512/pred_results',
...
visualizer = dict(
    ...
    output_dataset='ADE20K',
    save_dir=
    'my_projects/zero_shot/results/hots_v1/maskformer_swin-t_upernet_8xb2-160k_ade20k-512x512/show',
    target_dataset='HOTS_CAT',
    test_dataset='HOTS',
...
work_dir = 'my_projects/zero_shot/results/hots_v1/maskformer_swin-t_upernet_8xb2-160k_ade20k-512x512'
