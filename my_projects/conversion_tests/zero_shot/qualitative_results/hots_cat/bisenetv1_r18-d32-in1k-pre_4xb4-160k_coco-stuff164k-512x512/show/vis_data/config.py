...
launcher = 'none'
load_from = 'my_projects/conversion_tests/zero_shot/models/hots_cat/bisenetv1_r18-d32-in1k-pre_4xb4-160k_coco-stuff164k-512x512/weights.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    keep_results=True,
    output_dir=
    'work_dirs/bisenetv1_r18-d32-in1k-pre_4xb4-160k_coco-stuff164k-512x512/pred_results',
...
visualizer = dict(
    name='visualizer',
    save_dir=
    'work_dirs/bisenetv1_r18-d32-in1k-pre_4xb4-160k_coco-stuff164k-512x512/show',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = 'work_dirs/bisenetv1_r18-d32-in1k-pre_4xb4-160k_coco-stuff164k-512x512'
