...
data_root = '/media/ids/Ubuntu files/data/SODHOT-C/SemanticSegmentation/'
dataset_type = 'SODHOTCDataset'
default_hooks = dict(
    checkpoint=dict(
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=
        '/media/ids/Ubuntu files/data/SODHOT-C/SemanticSegmentation/',
        pipeline=[
...
work_dir = './work_dirs/bisenetv1_r18-d32-in1k-pre_1xb2-pre-coco-stuff164k-10k_sodhot-c-512x512'
