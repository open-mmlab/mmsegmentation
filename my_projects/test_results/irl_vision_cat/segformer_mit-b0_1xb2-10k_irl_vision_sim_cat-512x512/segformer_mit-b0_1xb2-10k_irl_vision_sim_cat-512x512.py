...
launcher = 'none'
load_from = 'my_projects/best_models/selection_trained/irl_vision_cat/segformer_mit-b0_1xb2-10k_irl_vision_sim_cat-512x512/weights.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    keep_results=True,
    output_dir=
    'my_projects/test_results/irl_vision_cat/segformer_mit-b0_1xb2-10k_irl_vision_sim_cat-512x512/pred_results',
...
visualizer = dict(
    name='visualizer',
    save_dir=
    'my_projects/test_results/irl_vision_cat/segformer_mit-b0_1xb2-10k_irl_vision_sim_cat-512x512/show',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = 'my_projects/test_results/irl_vision_cat/segformer_mit-b0_1xb2-10k_irl_vision_sim_cat-512x512'
