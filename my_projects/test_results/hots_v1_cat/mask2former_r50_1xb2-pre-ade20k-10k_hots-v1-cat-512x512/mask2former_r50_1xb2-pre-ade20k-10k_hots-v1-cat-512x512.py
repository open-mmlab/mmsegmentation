...
launcher = 'none'
load_from = 'my_projects/best_models/selection_trained/hots_v1_cat/mask2former_r50_1xb2-pre-ade20k-10k_hots-v1-cat-512x512/weights.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    keep_results=True,
    output_dir=
    'my_projects/test_results/hots_v1_cat/mask2former_r50_1xb2-pre-ade20k-10k_hots-v1-cat-512x512/pred_results',
...
visualizer = dict(
    name='visualizer',
    save_dir=
    'my_projects/test_results/hots_v1_cat/mask2former_r50_1xb2-pre-ade20k-10k_hots-v1-cat-512x512/show',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = 'my_projects/test_results/hots_v1_cat/mask2former_r50_1xb2-pre-ade20k-10k_hots-v1-cat-512x512'
