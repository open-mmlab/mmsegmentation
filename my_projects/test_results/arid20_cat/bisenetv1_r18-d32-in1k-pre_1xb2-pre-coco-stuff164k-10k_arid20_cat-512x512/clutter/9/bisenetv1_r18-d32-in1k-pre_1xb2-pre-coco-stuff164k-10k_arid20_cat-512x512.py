...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        data_prefix=dict(img_path='img_dir/9', seg_map_path='ann_dir/9'),
        data_root='/media/ids/Ubuntu files/data/ARID20_CAT/',
        pipeline=[
...
work_dir = 'my_projects/test_results/arid20_cat/bisenetv1_r18-d32-in1k-pre_1xb2-pre-coco-stuff164k-10k_arid20_cat-512x512/clutter/9'
