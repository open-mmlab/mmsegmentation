...
launcher = 'none'
load_from = 'my_projects/best_models/selection/segformer_mit-b0_1xb2-10k_hots-v1-512x512/weights.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    keep_results=True,
    output_dir=
    'my_projects/test_results/segformer_mit-b0_1xb2-10k_hots-v1-512x512/pred_results',
...
visualizer = dict(
    name='visualizer',
    save_dir=
    'my_projects/test_results/segformer_mit-b0_1xb2-10k_hots-v1-512x512/show',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = 'my_projects/test_results/segformer_mit-b0_1xb2-10k_hots-v1-512x512'
