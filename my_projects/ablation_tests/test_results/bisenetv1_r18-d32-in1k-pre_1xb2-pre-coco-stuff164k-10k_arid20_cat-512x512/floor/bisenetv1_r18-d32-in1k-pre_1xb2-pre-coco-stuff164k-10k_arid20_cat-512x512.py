...
test_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            img_path='img_dir/scene/floor',
            seg_map_path='ann_dir/scene/floor'),
        data_root='/media/ids/Ubuntu files/data/ARID20_CAT/',
        pipeline=[
...
work_dir = 'my_projects/ablation_tests/test_results/bisenetv1_r18-d32-in1k-pre_1xb2-pre-coco-stuff164k-10k_arid20_cat-512x512/floor'
