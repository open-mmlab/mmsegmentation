...
class CityscapesCoarseDataset(CustomDataset):
    """Cityscapes dataset.
    ...
    def __init__(self, **kwargs):
        super(CityscapesCoarseDataset, self).__init__(
    ...
    def _evaluate_cityscapes(self, results, logger, imgfile_prefix):
        ...
        for seg_map in mmcv.scandir(
                self.ann_dir, 'gtCoarse_labelIds.png', recursive=True):
