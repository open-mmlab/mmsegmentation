...
class COCOStuffDataset(CustomDataset):
    """COCO Stuff-10k/164k dataset.

    In segmentation map annotation for COCO-Stuff,
    '0' and '255' stands for unlabelled in 10k and 164k, respectively,
    which is not included in 182 categories.
    ``reduce_zero_label`` is used to addreas the '0' unlabelled issue.
