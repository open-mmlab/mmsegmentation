...
def rfnext_init_model(segmentor, cfg):
    ...
    Args:
        segmentor (nn.Module): The segmentor before initializing RF-Next.
        cfg (mmcv.Config): The config for RF-Next.
            If the RFSearchHook is defined in the cfg.custom_hooks,
            the segmentor will be initialized for RF-Next.
    """
    ...
    rfsearch_warp.init_model(segmentor)
