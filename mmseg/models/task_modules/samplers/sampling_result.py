...
from mmseg.utils.util_random import ensure_rng
...
class SamplingResult(util_mixins.NiceRepr):
    ...
    def __init__(self,
        ...
        self.num_gts = pos_inds.shape[0] + neg_inds.shape[0]
    ...
    def random(cls, rng=None, **kwargs):
        ...
        from mmseg.models.task_modules.assigners import AssignResult
        from mmseg.models.task_modules.samplers import RandomSampler
        rng = ensure_rng(rng)
