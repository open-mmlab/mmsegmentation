...
class BEiTPatchEmbed(nn.Module):
...
class VisionTransformer(BaseModule):
    ...
    def __init__(self,
        ...
        if use_rel_pos_bias:
            self.patch_embed = BEiTPatchEmbed(
                img_size=img_size[0],
                    ...
                    if nH1 != nH2:
                        ...
                        if L1 != L2:
                            ...
                            table_pretrained_resized = F.interpolate(
                                table_pretrained.permute(1, 0).view(
                                    1, nH1, S1, S1),
                                size=(S2, S2),
                                mode='bicubic')
                            state_dict[
                                table_key] = table_pretrained_resized.view(
                                    nH2, L2).permute(1, 0)
