        ...
        Returns:
            tuple[list[Tensor]]: A tuple contains two elements.
                ...
                - mask_pred_list (list[Tensor]): Mask logits for each \
                    ...
                    h, w).
        """
        # x is a list of the features from the encoder
        # for example: from resnet50 [(B, 256, 128, 256), (B, 512, 64, 128), (B, 1024, 32, 64), (B, 2048, 16, 32)]
        batch_size = x[0].shape[0]
        
        # mask_features is outs[-1], multi_scale_memorys is outs[:num_outs]
        # outs is feature pyramid from low resolution to high resolution, channel dimension is unified
...
class LDMHead(Mask2FormerHead):
    ...
    def _seg_data_to_instance_data(self, batch_data_samples: SampleList):
        ...
        for data_sample in batch_data_samples:
            ...
            for class_id in gt_labels:
                masks.append(gt_sem_seg == class_id)    # 将一张分割图分为每个类别的mask
    ...
    def predict(self, x: Tuple[Tensor], batch_img_metas: List[dict],
        ...
        ]   # img_path, seg_map_path, img_shaoe, etc. 
