...
data_root = 'I:\CD\Swin-Transformer-Semantic-Segmentation\data\ade\ADEChallengeData2016'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type='ADE20KDataset',
        data_root=
        'I:\CD\Swin-Transformer-Semantic-Segmentation\data\ade\ADEChallengeData2016',
