...
关于如何拼接数据集 (concatenate) 并一起训练它们，更多细节请参考 [拼接连接数据集](https://github.com/open-mmlab/mmsegmentation/blob/master/docs_zh_CN/tutorials/customize_datasets.md#%E6%8B%BC%E6%8E%A5%E6%95%B0%E6%8D%AE%E9%9B%86) 。
...
请参照 [这里](https://github.com/open-mmlab/mmsegmentation/blob/master/docs_zh_CN/inference.md) 来使用训练好的模型去预测 LoveDA 测试集并且提交到官网。
