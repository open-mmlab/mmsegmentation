...
# model_cfg
num_classes = 46
load_from = 'https://download.openmmlab.com/mmsegmentation/v0.5/maskformer/maskformer_r50-d32_8xb2-160k_ade20k-512x512/maskformer_r50-d32_8xb2-160k_ade20k-512x512_20221030_182724-3a9cfe45.pth'
model = dict(
    type='EncoderDecoder',
...
train_cfg = dict(
    type='IterBasedTrainLoop', max_iters=1000, val_interval=1000)
