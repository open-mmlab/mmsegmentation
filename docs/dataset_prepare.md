...
Please refer to [concat dataset](https://mmsegmentation.readthedocs.io/en/latest/tutorials/customize_datasets.html#concatenate-dataset) for details about how to concatenate them and train them together.
