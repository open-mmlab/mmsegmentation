...
optimizer = dict(
    type='SGD', lr=0.0001, momentum=0.9, weight_decay=0.0005, _scope_='mmseg')
optim_wrapper = dict(
    type='OptimWrapper',
...
work_dir = 'projects/Bactteria_Dataset/work_dirs/Bactteria_Det_unet_0.0001_CrossEntropyLoss/'
