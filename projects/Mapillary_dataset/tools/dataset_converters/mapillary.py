...
def mapillary_masklabel(RGB_label: np.ndarray,
    ...
    """
    colormap = RGB_label.astype('uint32')
    idx = np.array((colormap[:, :, 0] * 256 + colormap[:, :, 1]) * 256 +
                   colormap[:, :, 2]).astype('uint32')
...
def main():
    colormap2label_v1_2 = mapillary_colormap2label(color_map_v1_2)
    colormap2label_v2_0 = mapillary_colormap2label(color_map_v2_0)
