...
# rp = './data/EndoCV2020_EDD/EDD'
# save_img_path = './data/EndoCV2020_EDD/images/train'
# save_mask_path = './data/EndoCV2020_EDD/masks/train'
...
#     if '_BE.tif' in mask_name:
#         mask.save(os.path.join(save_mask_path, \
#                             mask_name.replace('_BE.tif', '_1.png')))
#     elif '_suspicious.tif' in mask_name:
#         mask.save(os.path.join(save_mask_path, \
#                   mask_name.replace('_suspicious.tif', '_2.png')))
#     elif '_HGD.tif' in mask_name:
#         mask.save(os.path.join(save_mask_path, \
#                       mask_name.replace('_HGD.tif', '_3.png')))
#     elif '_cancer.tif' in mask_name:
#         mask.save(os.path.join(save_mask_path, \
#                          mask_name.replace('_cancer.tif', '_4.png')))
#     elif '_polyp.tif' in mask_name:
#         mask.save(os.path.join(save_mask_path, \
#                           mask_name.replace('_polyp.tif', '_5.png')))
#     else:
#         print('=========================================================')
#         continue
