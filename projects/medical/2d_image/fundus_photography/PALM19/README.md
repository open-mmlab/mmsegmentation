...
This project supports **`PALM19`**, which can be downloaded from [here](https://tianchi.aliyun.com/dataset/dataDetail?dataId=127459).
...
![bac](https://raw.githubusercontent.com/uni-medical/medical-datasets-visualization/main/2d/semantic_seg/fundus_photography/PALM19/PALM19_dataset.png)
...
All the commands below rely on the correct configuration of `PYTHONPATH`, which should point to the project's directory so that Python can locate the module files. In `PALM19/` root directory, run the following line to add the current directory to `PYTHONPATH`:
...
- Decompress data to path `data/`. This will create a new folder named `data/PALM19/`, which contains the original image data.
...
| :-------------: | :------: | :-------: | :----: | :---: | :---: | :-------------------------------------------------------------------------: | :----------------------: |
| fcn_unet_s5-d16 |   unet   |  512x512  |  0.01  | 76.48 | 84.68 |  [config](./configs/fcn-unet-s5-d16_unet_1xb16-0.01-20k_PALM19-512x512.py)  | [model](<>) \| [log](<>) |
| fcn_unet_s5-d16 |   unet   |  512x512  | 0.001  | 61.06 | 63.69 | [config](./configs/fcn-unet-s5-d16_unet_1xb16-0.001-20k_PALM19-512x512.py)  | [model](<>) \| [log](<>) |
| fcn_unet_s5-d16 |   unet   |  512x512  | 0.0001 | 58.87 | 62.42 | [config](./configs/fcn-unet-s5-d16_unet_1xb16-0.0001-20k_PALM19-512x512.py) | [model](<>) \| [log](<>) |
