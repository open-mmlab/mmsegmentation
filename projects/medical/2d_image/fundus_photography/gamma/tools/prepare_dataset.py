...
def convert_label_pics_into_pngs(src_dir,
    ...
    convert_pics_into_pngs(
        os.path.join(
            root_path,
            '/GAMMA/task3_disc_cup_segmentation/training/fundus color images/'
        ),
        tgt_img_train_dir,
        suffix=img_suffix)
    ...
    convert_pics_into_pngs(
        os.path.join(
            root_path,
            '/GAMMA/task3_disc_cup_segmentation/testing/fundus color images/'),
        tgt_img_test_dir,
        suffix=img_suffix)
    ...
    convert_label_pics_into_pngs(
        os.path.join(
            root_path,
            '/GAMMA/task3_disc_cup_segmentation/training/Disc_Cup_Mask/'),
        tgt_mask_train_dir,
