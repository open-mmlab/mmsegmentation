...
This project support **`BChest Radiograph Anatomical Structure Segmentation (CRASS) `**, and the dataset used in this project can be downloaded from [here](https://crass.grand-challenge.org/).
