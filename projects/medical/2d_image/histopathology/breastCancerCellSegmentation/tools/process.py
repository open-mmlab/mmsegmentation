...
# rp = '/mnt/petrelfs/guosizheng/gsz/2d_fenge_todo/breast-cancer-cell-segmentation'  # noqa

# imgs = glob.glob(os.path.join(rp, 'Images', '*.tif'))
...
#     im.save(os.path.join(rp, 'Images', img.replace('_ccd.tif', '.png')))
#     os.remove(img)
...
#     im[im == 255] = 1
#     im = Image.fromarray(im)
#     im.save(os.path.join(rp, 'Masks', mask.replace('.TIF', '.png')))
#     os.remove(mask)
